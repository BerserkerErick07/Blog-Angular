...
export class BlogPostComponent implements OnInit {
  ...
  private markdownIt = new MarkdownIt(); //Instancia de la libreria markdown-it para parsear el contenido markdown
  content = ''; 
  ...
  constructor(
    ...
    //Inyectamos el servicio ActivatedRoute para obtener la ruta activa
    //y poder obtener el id del post que se va a visualizar
    //El id del post se obtiene a través de la propiedad params del objeto activateRoute
